  ...
  return (
    <div>
      ...
      <form onSubmit={handleSave}>
        ...
        {/* Helpful quick navigation to dedicated Email & Schema tabs */}
        <div style={{ background: "#f8fafc", border: "1px solid #e2e8f0", borderRadius: 12, padding: "18px 22px", marginBottom: 24, display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 16 }}>
          <div>
            <h4 style={{ margin: "0 0 4px 0", fontSize: 14, fontWeight: 700, color: "#1e293b" }}>
              Looking for Email Notifications or Schema Manager?
            </h4>
            <p style={{ margin: 0, fontSize: 13, color: "#64748b" }}>
              They now have their own dedicated tabs in the sidebar for easier access and management.
            </p>
          </div>
